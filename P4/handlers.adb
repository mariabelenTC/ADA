...
--=================CALCULAR TAMAÑO DE TABLA HASH==============================--

   HASH_SIZE:=get_max_clients/2;
...
--============================================================================--
	package Active_Clients is new Hash_Map_G (Key_Type => ASU.Unbounded_String ,
	...
	package Inactive_Clients is new Ordered_Map_G ( Key_Type => ASU.Unbounded_String ,
                                                   Value_Type => AC.Time,
	                                                "=" => ASU."=",
                                                   "<" => ASU."<",
                                                   Max_Cients=> 150);
